...
import { LiveHomeShowcase } from "@/components/landing/LiveHomeShowcase";
...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-[var(--s1)] pb-safe">
      ...
      {/* SHOW, don't tell — real live deals + leads scored right now (server-rendered, the strongest proof) */}
      <LiveDealShowcase />
      <LiveHomeShowcase />
