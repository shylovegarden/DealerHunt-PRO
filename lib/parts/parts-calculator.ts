...
export interface Part {
  id: string
  name: string
  category: 'engine' | 'transmission' | 'body' | 'interior' | 'electronics' | 'suspension' | 'brakes' | 'wheels' | 'other'
...
export const PARTS_DATABASE = {
  // Engine components
  engine: [
    { name: 'Engine Assembly', avgValue: 3500, weight: 350, removalTime: 8, difficulty: 'expert' },
    { name: 'Engine Block', avgValue: 1200, weight: 180, removalTime: 4, difficulty: 'difficult' },
    { name: 'Cylinder Head', avgValue: 800, weight: 60, removalTime: 3, difficulty: 'moderate' },
    { name: 'Crankshaft', avgValue: 600, weight: 45, removalTime: 2, difficulty: 'difficult' },
    { name: 'Pistons Set', avgValue: 400, weight: 25, removalTime: 2, difficulty: 'moderate' },
    { name: 'Turbocharger', avgValue: 800, weight: 35, removalTime: 1.5, difficulty: 'moderate' },
    { name: 'Alternator', avgValue: 250, weight: 15, removalTime: 0.5, difficulty: 'easy' },
    { name: 'Starter Motor', avgValue: 200, weight: 12, removalTime: 0.5, difficulty: 'easy' }
  ],
  
  // Transmission components
  transmission: [
    { name: 'Transmission Assembly', avgValue: 2800, weight: 150, removalTime: 6, difficulty: 'expert' },
    { name: 'Transmission Case', avgValue: 600, weight: 80, removalTime: 3, difficulty: 'difficult' },
    { name: 'Torque Converter', avgValue: 400, weight: 25, removalTime: 1, difficulty: 'moderate' },
    { name: 'Clutch Kit', avgValue: 350, weight: 20, removalTime: 2, difficulty: 'moderate' },
    { name: 'Driveshaft', avgValue: 300, weight: 30, removalTime: 1, difficulty: 'easy' }
  ],
  
  // Body components
  body: [
    { name: 'Hood', avgValue: 400, weight: 40, removalTime: 1, difficulty: 'easy' },
    { name: 'Front Fenders (pair)', avgValue: 600, weight: 50, removalTime: 1.5, difficulty: 'easy' },
    { name: 'Rear Fenders (pair)', avgValue: 500, weight: 45, removalTime: 1.5, difficulty: 'easy' },
    { name: 'Doors (set of 4)', avgValue: 800, weight: 120, removalTime: 2, difficulty: 'moderate' },
    { name: 'Trunk Lid', avgValue: 350, weight: 35, removalTime: 1, difficulty: 'easy' },
    { name: 'Bumper Front', avgValue: 300, weight: 25, removalTime: 0.5, difficulty: 'easy' },
    { name: 'Bumper Rear', avgValue: 250, weight: 20, removalTime: 0.5, difficulty: 'easy' },
    { name: 'Grille', avgValue: 200, weight: 10, removalTime: 0.5, difficulty: 'easy' }
  ],
  
  // Interior components
  interior: [
    { name: 'Dashboard Assembly', avgValue: 600, weight: 40, removalTime: 3, difficulty: 'moderate' },
    { name: 'Seats (full set)', avgValue: 800, weight: 80, removalTime: 2, difficulty: 'moderate' },
    { name: 'Center Console', avgValue: 250, weight: 20, removalTime: 1, difficulty: 'easy' },
    { name: 'Door Panels (set)', avgValue: 400, weight: 35, removalTime: 1.5, difficulty: 'easy' },
    { name: 'Steering Wheel', avgValue: 150, weight: 8, removalTime: 0.5, difficulty: 'easy' },
    { name: 'Instrument Cluster', avgValue: 300, weight: 5, removalTime: 1, difficulty: 'moderate' }
  ],
  
  // Electronics
  electronics: [
    { name: 'ECU/Engine Computer', avgValue: 400, weight: 2, removalTime: 0.5, difficulty: 'moderate' },
    { name: 'Audio System', avgValue: 200, weight: 15, removalTime: 1, difficulty: 'easy' },
    { name: 'Navigation System', avgValue: 350, weight: 8, removalTime: 1, difficulty: 'moderate' },
    { name: 'Airbag Control Module', avgValue: 250, weight: 3, removalTime: 1, difficulty: 'moderate' },
    { name: 'Body Control Module', avgValue: 200, weight: 2, removalTime: 0.5, difficulty: 'moderate' }
  ],
  
  // Suspension
  suspension: [
    { name: 'Struts (set of 4)', avgValue: 600, weight: 60, removalTime: 2, difficulty: 'moderate' },
    { name: 'Control Arms (set)', avgValue: 400, weight: 40, removalTime: 2, difficulty: 'moderate' },
    { name: 'Sway Bars (set)', avgValue: 200, weight: 25, removalTime: 1, difficulty: 'easy' },
    { name: 'Coil Springs (set)', avgValue: 300, weight: 30, removalTime: 1.5, difficulty: 'moderate' }
  ],
  
  // Brakes
  brakes: [
    { name: 'Brake Calipers (set)', avgValue: 400, weight: 30, removalTime: 1.5, difficulty: 'moderate' },
    { name: 'Brake Rotors (set)', avgValue: 200, weight: 40, removalTime: 1, difficulty: 'easy' },
    { name: 'ABS Module', avgValue: 350, weight: 8, removalTime: 1, difficulty: 'moderate' }
  ],
  
  // Wheels and Tires
  wheels: [
    { name: 'Wheels (set of 4)', avgValue: 600, weight: 80, removalTime: 1, difficulty: 'easy' },
    { name: 'Tires (set of 4)', avgValue: 400, weight: 100, removalTime: 1, difficulty: 'easy' },
    { name: 'Spare Tire Assembly', avgValue: 200, weight: 35, removalTime: 0.5, difficulty: 'easy' }
  ]
}
...
export const PARTS_SOURCES = [
  ...
  { name: 'ebay-motors-parts', url: 'https://www.ebay.com/motors/parts', commission: 0.10 },
...
export class PartsCalculator {
  ...
  async calculateTearDown(vehicleInfo: any): Promise<TearDownAnalysis> {
    ...
    const recommendations = this.generateRecommendations(vehicleInfo, parts, summary)
  ...
  private async generatePartsList(vehicleInfo: any): Promise<Part[]> {
    ...
    Object.entries(PARTS_DATABASE).forEach(([category, partTemplates]) => {
      partTemplates.forEach(template => {
        // Adjust value based on vehicle make/model/year
        const adjustedValue = this.adjustPartValue(template.avgValue, year, make, model)
        ...
        const part: Part = {
          ...
          price: adjustedValue * multiplier,
          estimatedValue: adjustedValue * multiplier,
          ...
          notes: `Estimated value based on ${year} ${make} ${model}`
        }
  ...
  private adjustPartValue(baseValue: number, year: number, make: string, model: string): number {
    ...
    if (age <= 3) adjustedValue *= 1.3 // Newer vehicles have more valuable parts
  ...
  private determinePartCondition(vehicleCondition: string): 'new' | 'used' | 'remanufactured' | 'salvage' {
  ...
  private calculateSummary(vehicleInfo: any, parts: Part[]) {
    const totalPartValue = parts.reduce((sum, part) => sum + part.estimatedValue, 0)
    const totalLaborHours = parts.reduce((sum, part) => sum + part.removalTime, 0)
  ...
  private calculateRiskScore(vehicleInfo: any, parts: Part[], netProfit: number): number {
  ...
  private generateRecommendations(vehicleInfo: any, parts: Part[], summary: any): string[] {
    const recommendations: string[] = []
    
    if (summary.netProfit > 3000) {
      recommendations.push('High profit margin detected - recommend proceeding with tear-down')
    } else if (summary.netProfit < 0) {
      recommendations.push('Negative profit projected - consider selling whole vehicle instead')
    }
    
    if (summary.riskScore > 70) {
      recommendations.push('High risk score - ensure thorough inspection before proceeding')
    }
    
    if (vehicleInfo.condition === 'salvage') {
      recommendations.push('Salvage title - verify parts market demand before tear-down')
    }
    
    // High-value parts recommendations
    const highValueParts = parts.filter(p => p.estimatedValue > 1000)
    if (highValueParts.length > 0) {
      recommendations.push(`Focus on high-value components: ${highValueParts.map(p => p.name).join(', ')}`)
    }
    
    // Labor recommendations
    if (summary.totalLaborHours > 40) {
      recommendations.push('Extensive labor required - consider professional dismantling service')
    }
  ...
  async compareProfitability(vehicleInfo: any): Promise<{
    ...
    const totalRepairCost = repairCosts.reduce((sum, repair) => sum + repair.estimatedCost, 0)
    const estimatedSalePrice = this.estimateResaleValue(vehicleInfo)
    const resaleNetProfit = estimatedSalePrice - vehicleInfo.purchasePrice - totalRepairCost
    const resaleROI = vehicleInfo.purchasePrice > 0 ? (resaleNetProfit / vehicleInfo.purchasePrice) * 100 : 0
    ...
    if (tearDown.summary.netProfit > resaleNetProfit * 1.2) {
      ...
      reasoning = 'Profits are similar - consider market conditions and available resources'
    }
